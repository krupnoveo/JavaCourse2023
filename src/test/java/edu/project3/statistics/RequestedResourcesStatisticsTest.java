...
public class RequestedResourcesStatisticsTest {
    @Test
    @DisplayName("RequestedResourcesStatistics.getData()")
    public void getData_shouldReturnCorrectResult() {
        ...
        resources.add("'/github.com'");
        resources.add("'/yandex.ru'");
        counts.add("2");
        counts.add("1");
        ...
        assertEquals(data, new RequestedResourcesStatistics().getData(wrapper));
    }
}
