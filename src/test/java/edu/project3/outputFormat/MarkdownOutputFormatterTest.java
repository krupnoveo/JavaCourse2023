...
public class MarkdownOutputFormatterTest {
    @Test
    @DisplayName("Тест MarkdownOutputFormatter.getFormattedOutput()")
    public void getFormattedOutput_shouldReturnCorrectResult() {
        ...
        String expected = """
            ...
            |'/github.com'|10        |
            |'/yandex.ru' |5         |""";
        String actual = new MarkdownOutputFormatter().getFormattedOutput(data);
