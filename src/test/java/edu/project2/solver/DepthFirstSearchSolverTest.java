...
public class DepthFirstSearchSolverTest {
    ...
    @Test
    @DisplayName("Тест DepthFirstSearchSolver.getPath() с корректными входными данными")
    public void getPath_fromDepthFirstSearchSolver_shouldReturnCorrectPath() {
        List<Cell> path = new DepthFirstSearchSolver().getPath(new Maze(5, 5, correctCells), correctCells[1][1], correctCells[3][3]);
    ...
    @Test
    @DisplayName("Тест DepthFirstSearchSolver.getPath() с некорректными входными данными")
    public void getPath_fromDepthFirstSearchSolver_shouldThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> {
            new DepthFirstSearchSolver().getPath(new Maze(5, 5, incorrectCells), incorrectCells[0][1], incorrectCells[3][3]);
        });
    }
}
