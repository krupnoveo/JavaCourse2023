...
public class ReadWriteLockPersonDatabaseTest {
    @Test
    @DisplayName("Тест ReadWriteLockPersonDatabaseTest.add()/ .delete()/ .findByName()/ .findByAddress()/ .findByPhone()")
    public void allMethods_shouldWorkCorrectly() {
        PersonDatabase personDatabase = new ReadWriteLockPersonDatabase();
